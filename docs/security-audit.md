# Security audit — mesh-icebreaker-bingo

Generated: **2026-05-17T13:28:05.622Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "92e57f0d0399a0850520a0b0de7f933f94d551c4629ff481fdc79db534a34732",
  "pubkeyB": "92e57f0d0399a0850520a0b0de7f933f94d551c4629ff481fdc79db534a34732"
}
```
...
```json
{
  "pubkeyA": "490c376ab32ec244",
  "pubkeyB": "cd081a539a9e0ab1"
}
```
...
```json
{
  "plantedExpiresAt": 1779024425615,
  "now": 1779024485618
}
```
...
```json
{
  "realPubkey": "d5ade233b7e68f14",
  "forgerPubkey": "8e8dc4da30a92548"
}
```
...
```json
{
  "forgedPubkey": "e7439f6ec635c6a5",
  "realPubkey": "8bc6cf19163aaf9e"
}
```
